  ...
  return (
    <div className="relative overflow-x-clip rounded-[2.5rem] bg-[#f5f0e7] pb-14 text-foreground shadow-[0_30px_120px_rgba(15,23,42,0.12)] dark:bg-background">
      ...
      <div className="relative z-10 px-4 py-6 md:px-6 md:py-8">
        {notices.length > 0 ? (
          <div className="mx-auto mb-6 max-w-6xl rounded-[1.9rem] border border-amber-300/60 bg-amber-50/90 px-5 py-4 text-sm text-amber-950 shadow-[0_12px_36px_rgba(120,53,15,0.08)] dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-100">
