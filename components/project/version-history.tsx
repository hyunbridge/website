...
// ─── Main Component ─────────────────────────────────────────────────
export function VersionHistory({ projectId, publishedVersionId, onVersionRestored }: VersionHistoryProps) {
  ...
  const handleRestore = async () => {
    ...
    setIsRestoring(true)
    try {
      await restoreProjectVersion(projectId, selectedVersion.version_number, user.id)
      toast({
